...
<head>
    ...
    <title>Crocodile Adventure - Enhanced</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <script>
        ...
        function render() {
            ...
            waterAreas.forEach(water => {
                ...
                ctx.beginPath();
                for (let i = water.x; i < water.x + water.width; i += 15) {
                    ctx.moveTo(i, water.y + 10);
                    ctx.lineTo(i + 10, water.y + 20);
                    ctx.moveTo(i, water.y + 30);
                    ctx.lineTo(i + 10, water.y + 40);
                }
                ctx.stroke();
            });
